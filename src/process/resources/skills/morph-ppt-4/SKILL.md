---
name: morph-ppt-4
description: Generate Morph-animated PPTs with officecli (description-driven component borrowing, non-clone 4.0 workflow)
---

# Morph PPT 4.0

Build Morph PPT decks with a stable workflow: morph1 design baseline + component description borrowing + controlled creative assembly.
...
## Component borrowing policy (core of 4.0)
...
Component admission guardrails (mandatory):
